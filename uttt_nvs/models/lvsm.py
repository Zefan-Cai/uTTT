...
class LossComputer:
    ...
    def calculate_loss(
        ...
        loss = l2_loss + self.lpips_loss_weight * lpips_loss
...
class Images2latent3D(nn.Module):
    ...
    def forward(self, data_batch):
        ...
        x, infos = self.transformer_blocks(x, info_dict)
        ...
        loss_metrics = self.loss_computer.calculate_loss(target_rendered_images, target["image"])
